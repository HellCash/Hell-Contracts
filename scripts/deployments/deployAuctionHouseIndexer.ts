...
export async function deployAuctionHouseIndexer(auctionHouseAddress: string, printLogs: boolean = true, initializeImplementation: boolean = true): Promise<Contract> {
