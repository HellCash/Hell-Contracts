...
export async function deployGreedStarterIndexer(greedStarterContractAddress: string, printLogs: boolean = true, initializeImplementation: boolean = true): Promise<Contract> {
